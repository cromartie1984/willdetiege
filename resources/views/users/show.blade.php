    ...
    <div class="container-fluid">
        ...
        <section class="section">
            <div class="card card-cascade cascading-admin-card">
                <div class="admin-up">
                    <i class="fa fa-users blue darken-3"></i>
                    <div class="data">
                        <h3>Résumé</h3>
                    </div>
                </div>
                ...
                <div class="card-block">
                    <div class="material-datatables">
                        <table class="table table-hover row-border" width="100%" id="users-list" cellspacing="0">
...
//$post->tags()->count()
		...
		CRUDitem = function( item, columns_list, column_defs, order, ajaxUrl, paging ) {
			...
			CRUDitem( "user", column_list, column_defs, [ 5, 'desc' ], '/admin/users/list', 5);
